========================================================================
    APLICACIÓN DE CONSOLA: jansson_test Información general 
    del proyecto
========================================================================

AppWizard ha creado esta aplicación jansson_test.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la jansson_test aplicación.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado jansson_test.pch y un archivo de 
